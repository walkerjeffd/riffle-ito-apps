...
## Residuals:
##    Min     1Q Median     3Q    Max 
##  -84.8  -46.1   10.9   23.1  248.1 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -198.507    131.520   -1.51     0.14    
## USGS           1.194      0.131    9.08  1.2e-13 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 55.3 on 74 degrees of freedom
## Multiple R-squared:  0.527,	Adjusted R-squared:  0.521 
## F-statistic: 82.5 on 1 and 74 DF,  p-value: 1.15e-13
```

This model has an R^2 = 0.527, which is not too bad considering there was no calibration and only the adjustment of a single parameter (the ratio of L/A).
